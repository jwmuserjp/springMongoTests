...
public class QueryApp {
    ...
    public static void main(String[] args) {
        ...
        User user1 = new User("100111", "ant", 10);
        User user2 = new User("100222", "bird", 20);
        User user3 = new User("100333", "cat", 30);
        User user4 = new User("100444", "dog", 40);
        User user5 = new User("100555", "elephant", 50);
        User user6 = new User("100666", "frog", 60);
        users.add(user1);
        users.add(user2);
        users.add(user3);
        users.add(user4);
